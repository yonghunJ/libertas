            ...
            <div className={classes.item}>
              <Grid container>
                <Grid item md={6} xs={12}>
                  ...
                  <Typography display="block" className={text.title3}>{t('common:mobile-landing.feature_title8')} </Typography>
                    ...
                    <li className={classes.liStyle}>
                      ...
                      {t('common:mobile-landing.feature_list8-1')}
                    </li>
                    <li className={classes.liStyle}>
                      <CheckIcon fontSize="small"/>
                      {t('common:mobile-landing.feature_list8-2')}
                    </li>
                    <li className={classes.liStyle}>
                      <CheckIcon fontSize="small"/>
                      {t('common:mobile-landing.feature_list8-3')}
                    </li>
                    </Typography>
                  </div>
                </Grid>
                  ...
                  <div className={classes.illustrationRight}>
                    ...
                    <ReactWOW animation="fadeInUpShort" delay="0.5s" duration="0.5s">
                      ...
                      <image
                        ...
                        xlinkHref={imgAPI.feature[6]}
                        alt="Feature(8) Security"
                        style={{ height: '90%' }}
                        transform="translate(5 0)"
                      />
                    <ReactWOW animation="fadeInUpShort" delay="0.7s" duration="0.5s">
                    <image
                      xlinkHref={imgAPI.featureIcon[7]}
